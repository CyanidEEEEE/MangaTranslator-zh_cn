...
class UIDetectionSettings:
    ...
    bubble_detector_model: str = "yolo_1"  # yolo_3 = comic speech bubble YOLOv8m
...
class UITranslationLLMSettings:
    ...
    ocr_method: str = "LLM"  # "LLM" or "paddleocr-vl"
...
class UIConfigState:
    ...
    def to_save_dict(self) -> Dict[str, Any]:
        ...
        data = {
            ...
            "pure_black_text": self.rendering.pure_black_text,
    ...
    def from_dict(data: Dict[str, Any]) -> "UIConfigState":
        ...
        return UIConfigState(
            ...
            rendering=UIRenderingSettings(
                ...
                pure_black_text=data.get("pure_black_text", defaults.get("pure_black_text", False)),
...
def map_ui_to_backend_config(
    ...
    rendering_cfg = RenderingConfig(
        ...
        pure_black_text=ui_state.rendering.pure_black_text,
